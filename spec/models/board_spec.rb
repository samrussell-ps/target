...
RSpec.describe Board, type: :model do
  it 'accepts with a valid DictionaryEntry and seed and centre letter offset' do
  ...
  it 'destroys submitted_words when the model is destroyed' do
    board = Board.create!(dictionary_entry: DictionaryEntry.find_by_word!("DEVELOPER"), word_shuffle_seed: 234, centre_letter_offset: 3)
